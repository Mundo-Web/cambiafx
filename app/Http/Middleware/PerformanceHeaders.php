...
class PerformanceHeaders
{
    ...
    private function applySecurityHeaders(Response $response): void
    {
        ...
        $csp = implode('; ', [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.culqi.com https://translate.google.com https://translate.googleapis.com https://translate-pa.googleapis.com https://connect.facebook.net https://embed.tawk.to https://va.tawk.to https://cdn.jsdelivr.net https://www.gstatic.com https://www.google-analytics.com https://analytics.tiktok.com https://googleads.g.doubleclick.net",
            ...
            "connect-src 'self' https://apiluna.cambiafx.pe https://translate.googleapis.com https://translate-pa.googleapis.com https://va.tawk.to wss://embed.tawk.to https://embed.tawk.to https://www.google-analytics.com https://analytics.tiktok.com https://googleads.g.doubleclick.net",

  ...
  return <section className="bg-[#FBF5F1] lg:bg-white p-[5%] text-center lg:px-[12.5%] lg:py-0">
    <div className="lg:flex lg:items-center lg:gap-8 bg-[#FBF5F1] lg:p-[5%] rounded-2xl">
      <div>
        ...
        <button aria-label="haz el test y crea tu fórmula" href='/test' className='bg-[#C5B8D4] text-white text-sm px-4 py-3 rounded my-4'>HAZ EL TEST Y CREA TU FÓRMULA</button>
      </div>

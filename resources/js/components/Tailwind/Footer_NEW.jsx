                                    ...
                                    <motion.button
                                        ...
                                        className={`font-bold text-sm px-6 py-3 rounded-full transition-colors ${
                                            !termsAccepted 
                                                ...
                                                : 'bg-secondary text-neutral-dark hover:bg-[#b7f556]'
                                        }`}
                            ...
                            >
                                <motion.div className="relative flex-shrink-0 mt-0.5">
                                    <motion.input 
                                        type="checkbox" 
                                        id="terms-checkbox" 
                                        className="h-3 w-3 text-secondary bg-transparent border-neutral-light rounded focus:ring-secondary checked:bg-secondary checked:border-secondary"

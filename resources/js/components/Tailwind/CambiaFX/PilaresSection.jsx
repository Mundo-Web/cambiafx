            ...
            <section className="bg-neutral-dark px-2 md:px-0 w-full relative overflow-hidden font-title">
                ...
                >
                    <div
                        ...
                        style={{
                            background:
                                "radial-gradient(ellipse at bottom right, rgba(124, 58, 237, 0.28), rgba(17, 24, 39, 0.35) 40%, transparent 75%)",
                            maskImage:
                                "linear-gradient(to left, transparent, rgba(0,0,0,0.45) 25%, rgba(0,0,0,0.95) 65%)",
                            WebkitMaskImage:
                                "linear-gradient(to left, transparent, rgba(0,0,0,0.45) 25%, rgba(0,0,0,0.95) 65%)",
                        }}
                    />
                ...
                <div className="hidden lg:block px-[5%] mx-auto relative z-10">
                    <div className="flex flex-col lg:flex-row items-end gap-12">
                        ...
                        >
                            ...
                            <motion.h2
                                className="text-5xl md:text-[64px] lg:text-[88px] font-medium text-white mb-6"
                            ...
                            >
                                <TextWithHighlight
                                    text={data?.title}
                                    color="bg-secondary font-semibold"
                                    split_coma
                                />
                            </motion.h2>
                            <motion.p
                        ...
                        <div className="relative flex-1">
                            ...
                            <div className="absolute -right-0 top-1/2 transform -translate-y-1/2 z-30 flex flex-col gap-4">
                                ...
                                >
                                    <svg
                                        className="w-5 h-5 text-white group-hover:text-[#BBFF52] transition-colors"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
